...
// Floating particles for the winner
...
const DriverCard = ({
  ...
  return (
    <motion.div
      ...
      className={`flex flex-col items-center relative ${config.scale}`}
    >
      {/* Winner particles */}
      ...
      {/* Driver card with glassmorphism */}
      <div
      ...
      <motion.div
        ...
        className={`${config.height} w-28 md:w-32 rounded-t-xl flex items-center justify-center mt-2 relative overflow-hidden`}
        style={{
      ...
      >
        ...
        <div className="relative z-10 text-center">
          ...
          <span className="font-racing text-3xl md:text-4xl text-muted-foreground/40">
            P{config.label}
          </span>
        </div>
      </motion.div>
...
const Podium = ({ drivers }: { drivers: PodiumDriverProps[] }) => {
  ...
  return (
    <div className="relative">
      ...
      {/* Data lines background animation */}
